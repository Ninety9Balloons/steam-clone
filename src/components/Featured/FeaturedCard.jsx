...
export default function FeaturedCard({
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row lg:h-[350px] items-start rounded shadow-[0_0_7px_0_#000000] lg:overflow-hidden">
      ...
      <img
        src={image}
        className="w-full lg:h-full lg:min-w-[70%] lg:object-fit lg:shadow-[0_0_10px_5px_#000000] z-20"
      />

      {/* Info */}
      <div
        className="text-white w-full lg:h-full p-2 pb-4 lg:pb-2 lg:flex lg:flex-col 
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="hidden lg:flex flex-col items-start">
            ...
            <p className="text-xs bg-[rgba(255,255,255,0.2)] px-1 py-[1px] rounded">
              Top Seller
            </p>
          </div>
          ...
          {discount != null ? (
            ...
            <p className="text-sm">
              {formattedPrice == 0 ? "Free to Play" : `$${formattedPrice}`}
            </p>
          )}
        </div>
      </div>
