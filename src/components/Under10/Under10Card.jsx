...
export default function under10Card({
  image,
  fullPrice,
  currentPrice,
  discount,
  ...
  return (
    <div
      className="flex flex-col bg-gradient-to-r from-[rgba(64,121,153,1)] to-[rgba(42,62,89,1)] hover:brightness-110 transition-all
    ...
    >
      ...
      <div className="h-[25%] flex justify-start items-center">
        {discount != null ? (
          ...
          <p className="text-sm text-white bg-[rgba(20,31,44,0.4)] py-[1px] px-1 ml-1">
